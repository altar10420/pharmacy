...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        productService.createProduct("Ibuprom", true, BigDecimal.valueOf(12.50));
        productService.createProduct("Aspirine",true, BigDecimal.valueOf(8.50));
        productService.createProduct("Paracetamol",false, BigDecimal.valueOf(19.50));
    }
}
